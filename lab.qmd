...
- Question:  Which chronic illness, hypertension or heart disease, increases the risk of having a stroke the most?
- Answer: 
...
Thus far, we have the risk/odds of having a stroke for variables which have TWO groups. Smoking status is different. Take a look at the following:

```{r}
strokes |> count(smoking_status)
```

This variable has four possibilities although Unknown isn't very helpful. Calculate the odds ratio of smokers to those who have never smoked. Then calculate the odds ratio of ex-smokers to those who have never smoked.

- Question:  Compared to those who never smoked, which group (smokers, former smokers) has the biggest risk of having a stroke according to this data?
- Answer: 
